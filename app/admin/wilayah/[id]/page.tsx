  ...
  const fetchWilayah = async () => {
    try {
      ...
      try {
        ...
        // Jika error (data lama berupa text "Rp..."), set detail ke kosong
        console.warn("Data lama terdeteksi, mereset detail per sektor")
        setSektorDetails({})
      }
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 space-y-2">
                  ...
                  <input type="text" value={coordinates} onChange={(e) => { setCoordinates(e.target.value); parseCoordinates(e.target.value) }} className={inputClassName} />
                </div>
                <div className="space-y-2">
                  ...
                  <input type="url" value={formData.gambarRdtr} onChange={(e) => setFormData({ ...formData, gambarRdtr: e.target.value })} className={inputClassName} />
                </div>
              </div>
              ...
              <div className="flex justify-end pt-6 border-t border-slate-100">
                <Button type="submit" disabled={saving} className="w-full md:w-80 h-14 bg-blue-600 hover:bg-slate-900 text-white rounded-2xl font-black uppercase tracking-widest text-xs shadow-xl shadow-blue-200 transition-all flex gap-3">
